...
public class FeatureServiceWithoutStatsTester {
  ...
  private static void testVariousRequestsWithoutStats(String[] args) {
    ...
    if (args.length < 3) {
      ...
      System.out.println("java -cp  ./ms-fs-performance-1.0-jar-with-dependencies.jar com.esri.arcgis.performance.test.FeatureServiceWithoutStatsTester https://us-iotdev.arcgis.com/fx1010d/maps/arcgis/rest/services/ faa10m 0");
      System.out.println("java -cp  ./ms-fs-performance-1.0-jar-with-dependencies.jar com.esri.arcgis.performance.test.FeatureServiceWithoutStatsTester https://us-iotdev.arcgis.com/fx1010d/maps/arcgis/rest/services/ faa10m 1");
      System.out.println("java -cp  ./ms-fs-performance-1.0-jar-with-dependencies.jar com.esri.arcgis.performance.test.FeatureServiceWithoutStatsTester https://us-iotdev.arcgis.com/fx1010d/maps/arcgis/rest/services/ faa10m 2 " +
          "20 120 speed 5 (20 -> runs, 120 -> timeout, speed -> plane speed field name, 5 -> the percentage of the speed range) ");
      System.out.println("java -cp  ./ms-fs-performance-1.0-jar-with-dependencies.jar com.esri.arcgis.performance.test.FeatureServiceWithoutStatsTester https://us-iotdev.arcgis.com/fx1010d/maps/arcgis/rest/services/ faa10m 3 " +
          "20 120 plane_id false (20 -> runs, 120 -> timeout, plane_id -> unique id field name, false -> is String field)");
      System.out.println("java -cp  ./ms-fs-performance-1.0-jar-with-dependencies.jar com.esri.arcgis.performance.test.FeatureServiceWithoutStatsTester https://us-iotdev.arcgis.com/fx1010d/maps/arcgis/rest/services/ faa10m 4 " +
          "20 120 25 (20 -> runs, 120 -> timeout, 25 -> bounding box width");
      System.out.println("java -cp  ./ms-fs-performance-1.0-jar-with-dependencies.jar com.esri.arcgis.performance.test.FeatureServiceWithoutStatsTester https://us-iotdev.arcgis.com/fx1010d/maps/arcgis/rest/services/ faa10m 5");
      System.out.println("java -cp  ./ms-fs-performance-1.0-jar-with-dependencies.jar com.esri.arcgis.performance.test.FeatureServiceWithoutStatsTester https://us-iotdev.arcgis.com/fx1010d/maps/arcgis/rest/services/ faa10m 6 " +
          "20 120 ts 10 (20 -> runs, 120 -> timeout, ts -> time field name, 5 -> time window percentage)");
      System.out.println("java -cp  ./ms-fs-performance-1.0-jar-with-dependencies.jar com.esri.arcgis.performance.test.FeatureServiceWithoutStatsTester https://us-iotdev.arcgis.com/fx1010d/maps/arcgis/rest/services/ faa10m 7 " +
          "20 120 35 ts 5 (20 -> runs, 120 -> timeout, 35 -> bounding box width, ts -> time field name, 5 -> time window percentage)");
      System.out.println("java -cp  ./ms-fs-performance-1.0-jar-with-dependencies.jar com.esri.arcgis.performance.test.FeatureServiceWithoutStatsTester https://us-iotdev.arcgis.com/fx1010d/maps/arcgis/rest/services/ faa10m 8 " +
      ...
      System.out.println("java -cp  ./ms-fs-performance-1.0-jar-with-dependencies.jar com.esri.arcgis.performance.test.FeatureServiceWithoutStatsTester https://us-iotdev.arcgis.com/fx1010d/maps/arcgis/rest/services/ faa10m 9 " +
