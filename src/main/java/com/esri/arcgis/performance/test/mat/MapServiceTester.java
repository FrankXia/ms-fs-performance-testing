...
public class MapServiceTester {
  ...
  private static void testOneService(String[] args) {
    if (args == null || args.length < 2) {
      System.out.println("Usage: java -cp ./ms-fs-performance-test-1.0-jar-with-dependencies.jar com.esri.arcgis.performance.test.mat.MapServiceTester <Service Url> <Service Name> {<Aggregation Style (square/pointyHexagon)> <optional bounding box>}");
      return;
    }
